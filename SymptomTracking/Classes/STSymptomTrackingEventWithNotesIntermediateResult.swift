...
open class STSymptomTrackingEventWithNotesIntermediateResult: RSRPIntermediateResult {
...
//    }
    ...
    public struct NoteResultStruct {
    ...
    public let notes: [String: NoteResultStruct]
